// @ts-check
/**
 * Tests para el flujo de rondas del juego
 */
...
describe('Flujo de rondas - maxRounds=1 termina en gameEnded', () => {
  ...
  test('Finaliza en gameEnded tras una única ronda', async () => {
    ...
    await new Promise((resolve, reject) => {
      emitWhenConnected(host, 'createRoom', { playerName: 'Host', roomName: 'Ronda Única', maxPlayers: 5, maxRounds: 1 });
    ...
    // Enviar palabras (ahora van a revisión social)
    ...
    // Simular finalización de revisión (esto normalmente lo haría el host)
    // Por ahora, solo verificamos que la revisión comenzó correctamente
    console.log('✅ Revisión iniciada correctamente');
